...
def select_file():
    ...
    showinfo(
        ...
        message=(current_agent.profile_name if (current_agent is not None) else "incorrect format, please check again")
    )
...
def select_game_window():
    ...
    if not current_agent:
        ...
        Label(top, font=( 'aria' ,10, 'bold' ),text="Click on the name below",fg="steel blue",bd=10,anchor='w').pack()
        Label(top, font=( 'aria' ,10, 'bold' ),text="To select your Nikke game window",fg="steel blue",bd=10,anchor='w').pack()
        ...
        def ok():
            ...
            current_status.set(f'Selected {active_window_name} as the game window')
            top.destroy()
...
#-----------------INFO TOP------------
lblinfo = Label(Tops, font=( 'aria' ,30, 'bold' ),text="Nikke Helper",fg="steel blue",bd=10,anchor='w')
...
#--------------------INFO Mid--------------
lbltip = Label(Tops, font=( 'aria' ,10, 'bold' ),text="Tip: Press DEL to stop a running task",fg="steel blue",anchor='w')
...
lblStatus = Label(Tops, font=( 'aria' ,10, 'bold' ),textvariable=current_status,fg="steel blue")
...
btnLoadProfile=Button(f1,padx=16,pady=8, bd=10 ,fg="black",font=('ariel' ,12,'bold'),width=20, text="Load Profile", bg="powder blue",command=select_file)
btnLoadProfile.grid(row=6, column=0)

btnLoadSkill=Button(f1,padx=16,pady=8, bd=10 ,fg="black",font=('ariel' ,12,'bold'),width=20, text="Reload Game", bg="powder blue",command=reload_game)
btnLoadSkill.grid(row=6, column=1)

btnInfChaos=Button(f1,padx=16,pady=8, bd=10 ,fg="black",font=('ariel' ,12,'bold'),width=20, text="Auto Daily", bg="powder blue",command=auto_daily)
btnInfChaos.grid(row=6, column=2)

btnx1=Button(f1,padx=16,pady=8, bd=10 ,fg="black",font=('ariel' ,12,'bold'),width=20, text="Select Game Window", bg="powder blue",command=select_game_window)
btnx1.grid(row=6, column=3)

btnLoadProfile=Button(f1,padx=16,pady=8, bd=10 ,fg="black",font=('ariel' ,12,'bold'),width=20, text="Claim Outpost Reward", bg="powder blue",command=claim_outpost_reward)
btnLoadProfile.grid(row=7, column=0)

btnLoadSkill=Button(f1,padx=16,pady=8, bd=10 ,fg="black",font=('ariel' ,12,'bold'),width=20, text="Claim Friendship Points", bg="powder blue",command=claim_friend_points)
